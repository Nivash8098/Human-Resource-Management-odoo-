    ...
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#2563EB] via-[#4338CA] to-[#6366F1] text-white p-6 sm:p-8 shadow-xl shadow-blue-500/15 select-none">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div>
            {isCheckedIn ? (
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800 shadow-xs">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                Checked In
              </span>
            ) : isCompleted ? (
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-100 text-blue-900 shadow-xs">
                <span className="w-2 h-2 rounded-full bg-blue-500" />
                Shift Completed
              </span>
            ) : (
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-xs font-bold bg-[#FFF2E2] text-[#9A4C00] shadow-xs">
