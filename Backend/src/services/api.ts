...
import { authBackendService } from './backend/auth.service';
import { attendanceBackendService } from './backend/attendance.service';
import { leaveBackendService } from './backend/leave.service';
import { payrollBackendService } from './backend/payroll.service';
import { documentBackendService } from './backend/document.service';
import { notificationBackendService } from './backend/notification.service';
import { activityBackendService } from './backend/activity.service';
import { employeeBackendService } from './backend/employee.service';
import { analyticsBackendService } from './backend/analytics.service';
