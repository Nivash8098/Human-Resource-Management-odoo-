import { NotificationItem } from '../../frontend/src/types';
...
export const notificationBackendService = {
  ...
  async createNotification(notif: Omit<NotificationItem, 'id' | 'created_at' | 'is_read'> & { is_read?: boolean }): Promise<NotificationItem> {
