  ...
  return (
    <Card className="shadow-xs border-slate-200/80">
      <CardHeader>
        ...
        <span className="text-xs text-slate-500 font-medium">Standard 40h target</span>
      </CardHeader>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 w-36 shrink-0">
                  ...
                  <div>
                    <h5 className="text-sm font-semibold text-slate-900">{day.label}</h5>
                ...
                <div className="flex items-center gap-4 sm:gap-8 flex-1 justify-start sm:justify-center text-xs">
                  <div>
                    <span className="text-slate-500 block text-[10px] uppercase font-semibold">In</span>
                    <span className="font-mono font-medium text-slate-800">{formatTime(checkIn)}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block text-[10px] uppercase font-semibold">Out</span>
                    <span className="font-mono font-medium text-slate-800">{formatTime(checkOut)}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block text-[10px] uppercase font-semibold">Duration</span>
                    <span className="font-mono font-bold text-slate-900">{formatDuration(duration)}</span>
                  </div>
                </div>
