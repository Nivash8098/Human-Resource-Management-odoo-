        ...
        <div
          ...
          className={`border-2 border-dashed rounded-xl p-6 text-center transition-colors cursor-pointer ${
            isDragging
              ...
              : 'border-slate-700 hover:border-sky-500/60 bg-[#0a101f]'
          }`}
        ...
        >
          ...
          {selectedFile ? (
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-emerald-950/60 text-emerald-400 flex items-center justify-center mb-2 ring-1 ring-emerald-500/40">
            ...
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-blue-950/80 text-sky-400 flex items-center justify-center mb-2 ring-1 ring-blue-500/30">
                <UploadCloud className="w-5 h-5" />
              </div>
              <p className="text-sm font-semibold text-white">Drag & drop your file here</p>
              <p className="text-xs text-slate-400 mt-1">or browse from your device (PDF, DOCX, PNG up to 10MB)</p>
            </div>
          )}
        </div>
