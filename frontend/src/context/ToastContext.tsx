        ...
        <AnimatePresence>
          {toasts.map((t) => (
            <motion.div
              ...
              className="pointer-events-auto flex items-start gap-3 p-4 rounded-2xl bg-[#0e1628] border border-slate-700/90 shadow-2xl shadow-black/80 text-slate-100 backdrop-blur-md"
            >
              ...
              <div className="flex-1 min-w-0 pr-1">
                ...
                {t.message && <p className="text-xs text-slate-300 mt-1 leading-relaxed font-medium">{t.message}</p>}
              </div>
              <button
                type="button"
