...
export const ReportsPage: React.FC = () => {
  ...
  const handleExport = () => {
    success('Report Exported', 'Nexora HR Analytics report CSV downloaded successfully.');
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400 font-medium">Recharts Visualizations</span>
          </div>
        ...
        <div className="flex items-center gap-2.5">
          <select
            ...
            className="text-xs font-semibold bg-[#0a101f] border border-slate-700 rounded-lg px-3 py-1.5 text-slate-200 outline-none"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardHeader className="p-0 pb-4">
            <div className="flex items-center justify-between w-full">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">30-Day punctuality & check-in trajectory</p>
              </div>
              <span className="text-xs font-mono font-bold text-emerald-400 bg-emerald-950/80 border border-emerald-800/40 px-2 py-0.5 rounded">
                Avg 96.2%
              </span>
            </div>
          </CardHeader>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={attendanceTrendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: '#0b1329', borderRadius: '8px', color: '#fff', border: '1px solid #1e293b', fontSize: '12px' }}
                />
                <Area type="monotone" dataKey="rate" stroke="#38bdf8" strokeWidth={2.5} fillOpacity={1} fill="url(#attendanceGradient)" name="Attendance %" />
                <Line type="monotone" dataKey="target" stroke="#64748b" strokeDasharray="4 4" strokeWidth={1.5} name="Target (95%)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </Card>
          ...
          <CardHeader className="p-0 pb-4">
            <div className="flex items-center justify-between w-full">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">Paid vs. Sick leave across teams</p>
              </div>
              <span className="text-xs font-mono font-bold text-sky-400 bg-blue-950/80 border border-blue-800/40 px-2 py-0.5 rounded">
                Summer Peak
              </span>
            </div>
          </CardHeader>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={leaveUtilizationData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Bar dataKey="paid" name="Paid Annual Leave" fill="#38bdf8" radius={[4, 4, 0, 0]} />
                <Bar dataKey="sick" name="Sick / Medical" fill="#34d399" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
        ...
        <Card className="p-5">
          <CardHeader className="p-0 pb-4">
            ...
            <p className="text-xs text-slate-400 mt-0.5">Workforce allocation by organizational unit</p>
          </CardHeader>
        ...
        <Card className="p-5">
          <CardHeader className="p-0 pb-4">
            ...
            <p className="text-xs text-slate-400 mt-0.5">In-Office vs. Hybrid vs. Fully Remote</p>
          </CardHeader>
