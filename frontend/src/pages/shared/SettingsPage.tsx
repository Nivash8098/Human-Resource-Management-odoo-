    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-400 font-medium">User Profile</span>
        </div>
      ...
      <Card className="p-5 border-blue-900/40 bg-gradient-to-br from-blue-950/40 via-[#0a1122] to-blue-950/20">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-200">Current Role Mode</span>
        ...
        <CardContent>
          <form onSubmit={handleSavePreferences} className="space-y-4">
            <div className="space-y-3">
              <label className="flex items-center justify-between p-3 rounded-lg bg-[#080e1c] border border-slate-800 cursor-pointer">
                <div>
                  <span className="text-xs font-bold text-white block">Email Notifications</span>
                  <span className="text-[11px] text-slate-400">Receive instant email updates for leave decisions and payroll receipts.</span>
                </div>
                <input
                  type="checkbox"
                  checked={emailAlerts}
              ...
              <label className="flex items-center justify-between p-3 rounded-lg bg-[#080e1c] border border-slate-800 cursor-pointer">
                <div>
                  <span className="text-xs font-bold text-white block">Workday Pulse Reminders</span>
                  <span className="text-[11px] text-slate-400">Prompt daily check-in reminders at the start of your shift.</span>
                </div>
                <input
                  type="checkbox"
      ...
      <Card className="p-5 space-y-4">
        <div className="flex items-center justify-between pb-2 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-300">Data & Service Layer Status</h3>
          </div>
        ...
        <p className="text-xs text-slate-400 leading-relaxed">
          Nexora HR frontend consumes domain endpoints through a clean, typed service abstraction layer (<code className="text-sky-400 font-mono">src/services/api.ts</code>), fully compatible with Supabase PostgreSQL, Row Level Security (RLS), and Realtime webhooks.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <div className="p-3 rounded-lg bg-[#080e1c] border border-slate-800">
            <span className="text-slate-400 block text-[10px] uppercase font-bold">Authentication Engine</span>
            <span className="font-semibold text-white">Supabase Auth + JWT Context</span>
          </div>
          <div className="p-3 rounded-lg bg-[#080e1c] border border-slate-800">
            <span className="text-slate-400 block text-[10px] uppercase font-bold">Security Boundary</span>
            <span className="font-semibold text-white">PostgreSQL Row-Level Security</span>
          </div>
        </div>
      </Card>
    </div>
